...
from .serializers import ListPostSerializer, ListTagsSerializer, CreatePostSerializer
...
class FilterTagPostView(ListAPIView):
    ...
    def get(self, request, tag_slug: str, format=None):
        ...
        if tag is None:
            return Response({"status_code": 204, "message": "El tag ingresado no existe"}, status.HTTP_204_NO_CONTENT)
